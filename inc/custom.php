...
{
    echo '<span id="footer-thankyou">Theme Development by <a href="http://higatech.net" target="_blank">MNH</a></span>';
}

// Customize function.
if (! function_exists('mnh_customize_name_panel_section')) {
    // Customize Register action.
    add_action('customize_register', 'mnh_customize_name_panel_section');
     ...
     * @since  1.0.0
     */
    function mnh_customize_name_panel_section($wp_customize)
    {
        // Panel: Name.
