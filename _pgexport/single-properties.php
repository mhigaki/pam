                                                    ...
                                                    <div class="col-md-4 col-sm-6">
                                                        <ul>
                                                            <?php if ( get_field( 'informacoes_planta_area' ) ) : ?>
                                                                <li>
                                                                    <strong><?php _e( 'Área(m²):', 'pam' ); ?></strong>
                                                            ...
                                                            <li>
                                                                <strong><?php _e( 'Construído em:', 'pam' ); ?></strong>
                                                                <?php _e( '2018', 'pam' ); ?>
                                                            </li>
                                                            <li>
                                                            ...
                                                            <?php if ( get_field( 'informacoes_planta_garagem' ) ) : ?>
                                                                <li>
                                                                    <strong><?php _e( 'Vagas:', 'pam' ); ?></strong>
                                                    ...
                                                    <div class="col-md-4 col-sm-6">
                                                        <ul>
                                                            ...
                                                            <?php if ( get_field( 'cidade' ) ) : ?>
                                                                <li>
                                                                    <strong><?php _e( 'Cidade:', 'pam' ); ?></strong>
