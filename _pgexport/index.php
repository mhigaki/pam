                                    ...
                                    <div class="property-box">
                                            ...
                                            <a href="<?php echo esc_url( get_permalink() ); ?>" class="property-img"> <div class="listing-badges">
                                                    ...
                                                    <?php if( !empty( $terms ) ) : ?>
                                                        <?php foreach( $terms as $term ) : ?>
                                                            <span class="featured" style="background-color:<?php echo get_field( 'selecione_a_cor' ); ?>;"><?php echo $term->name; ?></span>
                                                        <?php endforeach; ?>
                                                    <?php endif; ?>
                                        ...
                                        <div class="detail">
                                            ...
                                            <div class="location">
                                                <?php if ( get_field( 'endereco' ) ) : ?>
                                                    <a href="<?php echo get_field( 'endereco' ); ?>"> <i class="fa fa-map-marker"></i><?php echo get_field( 'endereco' ); ?> </a>
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="footer clearfix">
                                            <div class="pull-left days">
                                                <p><?php the_modified_date( null, '<i class="flaticon-time"></i>' ); ?></p>
                                            </div>
                                            <ul class="pull-right">
                                                <li>
