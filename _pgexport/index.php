                                        ...
                                        <div class="category_bg_box cat-1-bg">
                                            <div class="category-overlay">
                                                <div class="category-content">
                                                    <h3 class="category-title"> <?php $terms = get_the_terms( '188', 'properties_types' ) ?><?php if( !empty( $terms ) ) : ?><?php foreach( $terms as $term ) : ?><a href="<?php echo esc_url( get_term_link( $term, 'properties_types' ) ) ?>"><?php echo $term->name; ?></a><?php endforeach; ?><?php endif; ?> </h3>
