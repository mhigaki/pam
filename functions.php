...
function pam_init() {
    ...
    'public' => true,
    'hierarchical' => true,
    'supports' => array( 'title', 'custom-fields', 'editor', 'thumbnail', 'author', 'excerpt', 'trackbacks', 'comments', 'revisions', 'page-attributes', 'post-formats' ),
    'has_archive' => true,
    'show_in_rest' => true,
    'show_in_menu' => true,
    ...
    'public' => true,
    'hierarchical' => true,
    'supports' => array( 'title', 'editor', 'author', 'thumbnail', 'excerpt', 'custom-fields', 'page-attributes', 'post-formats', 'revisions', 'comments', 'trackbacks' ),
    'has_archive' => true,
    'show_in_rest' => true,
    'show_in_menu' => true,
...
function pam_customize_register( $wp_customize ) {
    ...
    'type' => 'theme_mod',
    'default' => __( 'tel:5511930305500', 'pam' ),
    'sanitize_callback' => $pgwp_sanitize
  ));

    $wp_customize->add_control( 'pam_sc_header_phone_lnk', array(
    'label' => __( 'Telefone Link', 'pam' ),
    'type' => 'url',
    'section' => 'pam_header'
  ));
    ...
    $wp_customize->add_setting( 'pam_sc_header_phone', array(
    'type' => 'theme_mod',
    'default' => __( '+55 11 93030-5500', 'pam' ),
    'sanitize_callback' => $pgwp_sanitize
  ));
    ...
    $wp_customize->add_setting( 'pam_sc_partners_display', array(
    'type' => 'theme_mod',
    'sanitize_callback' => $pgwp_sanitize
  ));

    $wp_customize->add_control( 'pam_sc_partners_display', array(
    ...
    $wp_customize->add_section( 'pam_default_cs', array('title' => 'Default section'));

    $wp_customize->add_setting( 'sub-banner_telefone', array(
    'type' => 'theme_mod',
    'sanitize_callback' => $pgwp_sanitize
  ));

    $wp_customize->add_control( 'sub-banner_telefone', array(
    'label' => __( 'Telefone Link', 'pam' ),
    'type' => 'text',
    'section' => 'pam_default_cs'
  ));
